...
ui <- tagList(
  tags$head(
    tags$style(HTML("
      /* Imagen de fondo fija para toda la app */
      body {
        background-image: url('www/upscalemedia-transformed.png');
      ...
      /* Capa semitransparente general para todo el contenido */
      .main-container {
        background-color: rgba(255, 255, 255, 0.8); /* Blanco 80% opaco */
        padding: 20px;
