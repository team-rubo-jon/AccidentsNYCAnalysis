...
## Variables 'LONGITUDE' y 'LATITUDE'
...
## Variables de las personas heridas o muertas
...
```
*HAY QUE HACERLO MÁS GRANDE PARA QUE SE VEA BIEN* (He quitado que muestre el total ya que se muestra en el grafico anterior)
...
data_sampled |> 
  select(NUM_PERSONS_INJURED, NUM_PEDESTRIANS_INJURED, NUM_CYCLIST_INJURED, NUM_MOTORIST_INJURED,
         NUM_PERSONS_KILLED, NUM_PEDESTRIANS_KILLED, NUM_CYCLIST_KILLED, NUM_MOTORIST_KILLED) |> 
    ggpairs(title = "Matriz de Correlación entre Variables")
