...
## Frecuencia en distintos intervalos de tiempo:

*CAMBIAR ESTILO GRAFICOS COMO EN LA APP*
...
data_time |>
  ...
  labs(title = "Evolución de frecuencia de accidentes mensualmente",
       x = "Mes",
       y = "Frecuencia") +
  theme_minimal()
...
En conclusión, la matriz de correlaciones muestra relaciones fuertes entre variables agregadas y sus subcomponentes, como entre personas heridas y motoristas heridos, lo cual es esperable y refleja coherencia en los datos; sin embargo, la mayoría de las demás correlaciones entre heridos y fallecidos de distintos grupos (peatones, ciclistas, motoristas) son débiles o prácticamente nulas, lo que sugiere que estas variables afectan a poblaciones distintas y no presentan multicolinealidad significativa.
