...
# Crear y aplicar el tema Bootstrap personalizado al documento
ny_theme <- bs_theme(
  version = 5,
...
# Activar tema visual para los gráficos base
...
# Aplicar el tema de ggplot personalizado
theme_set(theme_nyc())
```
...
Añado una correción de las variables VECHICLE_1 y VEHICLE_2 para que luego no den problemas:
...
Si es necesario, luego se puede añadir la corrección antes del muestre de datos.
