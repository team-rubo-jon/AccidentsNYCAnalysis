...
data_cleaned |> 
  select(BOROUGH, ZIP.CODE) |> 
  filter(BOROUGH=='')
  
# data |> 
#   select(LATITUDE, LONGITUDE, LOCATION) |> 
#   filter(is.na(LATITUDE), is.na(LONGITUDE), LOCATION == '')
# 
# tabla <- data |> 
#   select(LOCATION, ON.STREET.NAME) |> 
#   filter(LOCATION == '')
# 
# tabla <- tabla |> 
#   filter(LOCATION == "") |>  # Filtra donde LOCATION está vacío
#   count(ON.STREET.NAME, name = "FREQUENCY") |>  # Cuenta las ocurrencias
