...
Por ultimo, analizaremos las variables correspondientes al tipo de vehículo primario y secundario implicados en el accidente. De forma similar a la varaible anterior, es una variable categórica, por lo que primero, vamos a ver la frecuencia de las distintos vehículos involucrados en los accidentes registrados. Para ello, vamos a crear una tabla para cada variable con su frecuencia.
